#' LBL: Logistic and QUantitative Bayesian Lasso for Detecting Rare (or Common) Haplotype Association
#'
...
#' The current implementation considers dichotomous and quantitative traits. A future release will include survival traits.
...
#' that the family data is independent of the case-control data). The QBLbs function is designed for quantitative traits while also controlling for population stratification using principal components (PCs).
#'
...
#' \code{\link{QBLbs}}:  MCMC algorithm to obtain posterior samples for a quantitative trait.
#'
